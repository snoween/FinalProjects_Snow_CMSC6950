...
def main():
    ...
    # --- Code thay thế Figure 3: Candlestick dùng thuần Matplotlib ---
    
    # Lấy 60 ngày cuối để vẽ cho rõ
    df_subset = df.tail(60).copy()
    
    plt.figure(figsize=(12, 6))
    
    # Định nghĩa màu: Xanh (Tăng), Đỏ (Giảm)
